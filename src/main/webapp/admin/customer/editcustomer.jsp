<%@page import="com.halilkoca.model.customer.Customer"%>
...
<html lang="tr">
  <head>
    ...
    <title>${customer.getUsername() } Edit Detail | HeCommerce! </title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <form id="demo-form" data-parsley-validate action="register" method="POST" accept-charset="utf-8">
              	<div class="x_panel">
                  <div class="x_title">
                    <h2>${customer.getUsername() } Detayları Düzenle <small>${customer.getFirstName() } ${customer.getLastName() }</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
				...
				<!-- start form for validation -->
					...
					<div class="col-md-6 col-xs-12">
						...
						<input type="text" id="username" class="form-control" name="username" required="required" value="${customer.getUsername()}"/>
						</p>
						
						<p>
						<label for="email">E-posta Adresi * :</label>
						<input type="email" id="email" class="form-control" name="email" data-parsley-trigger="change" required="required" value="${customer.getEmail() }"/>
						</p>
						...
						<input type="text" id="firstname" class="form-control" name="firstname" required="required" value="${customer.getFirstName() }"/>
						</p>
						
						<p>
						<label for="lastname">Soyisim * :</label>
						<input type="text" id="lastname" class="form-control" name="lastname" required="required" value="${customer.getLastName() }"/>
						</p>
						<p>
						<label for="company">Şirketi :</label>
						<input type="text" id="company" class="form-control" name="company" value="${customer.getCompany() }"/>
						</p>					
						<p>
						...
						if(customer.getGender().getId_gender() == 1)
						{
						%>
						...
						%>
						<input type="radio" class="flat" name="gender" id="gender1" value="1" /> <label for="gender1"> Bay</label>
						</p>
						<p>
						<input type="radio" class="flat" name="gender" id="gender2" value="2" checked/> <label for="gender2"> Bayan</label>
						</p>		
							<%
						}
						...
						placeholder="Doğum Tarihi" aria-describedby="inputSuccess2Status3" required="required" value="${customer.getBirthday()} }"/>
					...
					<div class="col-md-6 col-xs-12">
						...
						<input type="text" id="website" class="form-control" name="website" value="${customer.getWebsite() }" />
						</p>
						
						<p>
						<label for="outstandingallowamount">Aylık Harcama Limiti * :</label>
						<input type="number" id="outstandingallowamount" class="form-control" name="outstandingallowamount" data-parsley-trigger="change" required="required" value="${customer.getOutstandingAllowAmount() }"/>
						</p>
						<p>
						<label for="maxpaymentdays">Ödeme Süresi * :</label>
						<input type="number" id="maxpaymentdays" class="form-control" name="maxpaymentdays" data-parsley-trigger="change" required="required" value="${customer.getMaxPaymentDays() }"/>						
						</p>
						
						<p>			
						<label for="showpublicprices">Fiyatları Göster:</label>
						<input type="checkbox" name="showpublicprices" id="showpublicprices" value="1" class="js-switch" />
						</p>
						
						<p>
						<label for="active">Hesap Aktif Mi:</label> 
						<input type="checkbox" name="active" id="active" value="1" class="js-switch" />
						</p>
						...
						<textarea id="note" class="form-control" name="note" value="${customer.getNote() }"></textarea>
						<br/>
				...
				<!-- end form for validations -->                    
              	...
              	<div class="x_panel">
                  <div class="x_title">
                    <h2>Adres Tipi: ${address.getAlias() }<small> Müşteri Adres Detayları </small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
				...
				<!-- start form for validation -->
					...
					<div class="col-md-4 col-xs-12">
						...
						name="country" required="required" value="${address.getCountry().getName()}"/>						
						</p>										
						<p>
						<label for="city">İl * :</label>
						<input type="text" id="city" class="form-control" 
						name="city" required="required" value="${address.getCity().getName()}"/>
						</p>
						<p>
						<label for="district">İlçe * :</label>
						<input type="text" id="district" class="form-control" 
						name="district" required="required" value="${address.getDistrict().getName()}"/>
						</p>
						<p>
						<label for=""address1"">Adres 1 * :</label>
						<input type="text" id=""address1"" class="form-control" 
						name="address1" required="required" value="${address.getAddress1() }"/>
						</p>
						<p>
						<label for="address2">Adres 2 * :</label>
						<input type="text" id="address2" class="form-control" 
						name="address2" required="required" value="${address.getAddress2() }"/>
						</p>
						<p>
						<label for="postcode">Posta Kodu * :</label>
						<input type="text" id="postcode" class="form-control" 
						name="postcode" required="required" value="${address.getPostcode() }"/>
						</p>						
